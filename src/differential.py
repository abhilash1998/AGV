...
def __init__(self):
        ...
        self.ticks_meter =  28800/34.562  # The number of wheel encoder ticks per meter of travel
        ...
        rospy.Subscriber("encoder", Int16MultiArray, self.wheelCallback)
    ...
    def wheelCallback(self, msg):
        ...
        self.left = msg.data[1]
        self.right =msg.data[2]
